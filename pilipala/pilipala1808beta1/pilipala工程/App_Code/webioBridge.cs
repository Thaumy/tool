...
public class webioBridge : Page
{
    ...
    public List<postData> pstlst_comn_get()
    {
        ...
        DataTable postDataTable = mysqlCH.getTable("select * from dbname.view_index_pstlst_comn");
    ...
    public postData pst_top_get()
    {
        ...
        DataTable postDataTable = mysqlCH.getTable("select * from dbname.view_index_pstlst_top");
    ...
    public List<postData> pstlst_menu_get()
    {
        ...
        DataTable postDataTable = mysqlCH.getTable("select * from dbname.view_index_pstlst_menu");
    ...
    public postData post_pDget(string post_id)
    {
        ...
        //获得展示可用的文章postData
        DataTable postDataTable = mysqlCH.getTable("select * from dbname.view_post_pst_datalst where post_id = " + post_id);
