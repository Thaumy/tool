    ...
    <div class="clearfix borderbox" id="page">
        ...
        <div class="clearfix grpelem" id="ptop">
            ...
            <div class="clearfix colelem" id="pu8280">
                ...
                <div class="museBGSize grpelem" id="u9269" <%Response.Write(wb.pst_stripClr_arrange(wb.pst_top_get().color_strip)); %>>
                    <!-- content -->
                    <div class="fluid_height_spacer"></div>
                </div>
            </div>
            <div class="shadow rounded-corners clearfix colelem" id="u8301">
                ...
                <div class="clearfix grpelem" id="u8285-4">
                    ...
                    <a href="post.aspx?post_id=<%Response.Write(wb.pst_top_get().post_id); %>" style="text-decoration: none; color: black">
                    <p><%Response.Write(wb.pst_top_get().post_title); %></p>
                    </a>
                        <!-- 给文本添加链接 -->
                ...
                <div class="clearfix grpelem" id="pu8274-5">
                    ...
                    <div class="clearfix colelem" id="u8274-5">
                        ...
                        <ul class="list0 nls-None" id="u8274-3">
                            <li><%Response.Write(wb.pst_top_get().count_browse); %></li>
                        </ul>
                    </div>
                    <div class="clearfix colelem" id="u8281-5">
                        <!-- content -->
                        <ul class="list0 nls-None" id="u8281-3">
                            <li><%Response.Write(wb.pst_top_get().count_review); %></li>
                        </ul>
                    </div>
                </div>
            </div>

            <%foreach (StdLib.postData pstlst_pD in wb.pstlst_comn_get())
                { %>
            <div class="shadow rounded-corners clearfix colelem" id="u8284">
                ...
                <div class="clearfix colelem" id="pu8278-4">
                    ...
                    <div class="clearfix grpelem" id="u8278-4">
                        ...
                        <a href="post.aspx?post_id=<%Response.Write(pstlst_pD.post_id); %>" style="text-decoration: none; color: black">
                            <p><%Response.Write(pstlst_pD.post_title); %></p>
                        </a>
                        <!-- 给文本添加链接 -->

                    </div>
                    <div class="museBGSize grpelem" id="u9244" <%Response.Write(wb.pst_stripClr_arrange(pstlst_pD.color_strip)); %>>
                        <!-- content -->
                        <div class="fluid_height_spacer"></div>
                    </div>
                </div>
                <div class="clearfix colelem" id="u8287-4">
                    <!-- content -->
                    <p><%Response.Write(pstlst_pD.post_summary); %></p>
                </div>
            </div>
