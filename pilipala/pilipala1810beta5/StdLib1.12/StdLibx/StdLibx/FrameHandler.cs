...
namespace StdLib
{
    namespace FrameHandler//版本控制
    {
        ...
        public sealed class LibInformation : IStdLibFrame
        {
            ...
            private static string _HlinfURL = "https://thaumy.github.io/StdLib1x/xplore/st112_Hlinf.html";

            private int _projectVer = 112;//1.12

            private string _projectMoniker = "st112";
