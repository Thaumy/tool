    ...
    namespace ViewHandler
    {
        namespace pilipala
        {
            ...
            public static class palaRoot
            {
                ...
                private static string dft_planTable = "pala_plan";
                private static string dft_postTable = "pala_post";
                private static string dft_userTable = "pala_user";

                private static string dft_postExTable = "pala_post_ex";
                private static string dft_userExTable = "";

                private static string dft_planView = "view_pala_plan";
                private static string dft_userView = "view_pala_user";

                private static string dft_indexCommonPoatListView = "view_idx_comn_plst";
                private static string dft_indexMenuPostListView = "view_idx_menu_plst";
                private static string dft_indexToppingPostListView = "view_idx_top_plst";

                private static string dft_wordPostView = "view_wrd_post";
                #endregion
                ...
                private static string _planTable;
                private static string _postTable;
                private static string _userTable;

                private static string _postExTable;
                private static string _userExTable;

                private static string _planView;
                private static string _userView;

                private static string _indexCommonPoatListView;
                private static string _indexMenuPostListView;
                private static string _indexToppingPostListView;

                private static string _wordPostView;
                ...
                {
                    get { return _planTable; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _planTable = dft_planTable;
                        }
                        else
                        {
                            _planTable = value;
                ...
                /// 文章表
                /// </summary>
                public static string postTable
                {
                    get { return _postTable; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _postTable = dft_postTable;
                        }
                        else
                        {
                            _postTable = value;
                ...
                /// 文章拓展表
                /// </summary>
                public static string postExTable
                {
                    get { return _postExTable; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _postExTable = dft_postExTable;
                        }
                        else
                        {
                            _postExTable = value;
                ...
                /// 用户拓展表
                /// </summary>
                public static string userExTable
                {
                    get { return _userExTable; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _userExTable = dft_userExTable;
                        }
                        else
                        {
                            _userExTable = value;
                ...
                {
                    get { return _planView; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _planView = dft_planView;
                        }
                        else
                        {
                            _planView = value;
                ...
                /// 首页标准文章列表视图
                /// </summary>
                public static string indexCommonPoatListView
                {
                    get { return _indexCommonPoatListView; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _indexCommonPoatListView = dft_indexCommonPoatListView;
                        }
                        else
                        {
                            _indexCommonPoatListView = value;
                        }
                    }
                }
                ...
                /// 首页菜单文章列表视图
                /// </summary>
                public static string indexMenuPostListView
                {
                    get { return _indexMenuPostListView; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _indexMenuPostListView = dft_indexMenuPostListView;
                        }
                        else
                        {
                            _indexMenuPostListView = value;
                        }
                    }
                }
                /// <summary>
                /// 首页置顶文章列表视图
                /// </summary>
                public static string indexToppingPostListView
                {
                    get { return _indexToppingPostListView; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _indexToppingPostListView = dft_indexToppingPostListView;
                        }
                        else
                        {
                            _indexToppingPostListView = value;
                        }
                    }
                }
                ...
                /// 文章页文章视图
                /// </summary>
                public static string wordPostView
                {
                    get { return _wordPostView; }
                    set
                    {
                        if (value == "defaultSet")
                        {
                            _wordPostView = dft_wordPostView;
                        }
                        else
                        {
                            _wordPostView = value;
                ...
                public static void defaultSet()
                {
                    ...
                    _indexCommonPoatListView = dft_indexCommonPoatListView;
                    _indexMenuPostListView = dft_indexMenuPostListView;
                    _indexToppingPostListView = dft_indexMenuPostListView;
            ...
            public class palaPlan : Ipala
            {
                ...
                public palaPlan(int plan_id, DataHandler.MySqlConnectionHandler MySqlConnectionHandler, string dataBaseName)
                {
                ...
                private void start(int plan_id)
                {
                    try
                    {
                        using (MySqlCommand MySqlCommand = new MySqlCommand("select * from " + _dataBaseName + "." + palaRoot.planView + " where plan_id = ?plan_id"))
                        {
            ...
            public class palaUser : Ipala
            {
                ...
                /// <param name="dataBaseName">pilipala数据库名</param>
                public palaUser(DataHandler.MySqlConnectionHandler MySqlConnectionHandler, string dataBaseName)
                {
                    this.MySqlConnectionHandler = MySqlConnectionHandler;
                    _dataBaseName = dataBaseName;
                }
                ...
                /// <param name="dataBaseName">pilipala数据库名</param>
                public palaUser(int user_id, DataHandler.MySqlConnectionHandler MySqlConnectionHandler, string dataBaseName)
                {
                    this.MySqlConnectionHandler = MySqlConnectionHandler;
                    _dataBaseName = dataBaseName;
                ...
                public void start(int user_id)
                {
                    try
                    {
                        using (MySqlCommand MySqlCommand = new MySqlCommand("select * from " + _dataBaseName + "." + palaRoot.userView + " where user_id = ?user_id"))
                        {
            ...
            public class palaFunction : Page, Ipala
            {
                ...
                public DataRow random(int post_id)
                {
                    ...
                    using
                        ...
                        MySqlCommand MySqlCommand = new MySqlCommand("call " + _dataBaseName + ".random_post(?post_id)")
                        )
                    {
                        //添加参数
                ...
                /// <returns>返回文章拓展数据</returns>
                public postEx postEx(int post_id)
                {
                    //新建文章拓展数据
                    postEx postEx = new postEx();

                    using (MySqlCommand MySqlCommand = new MySqlCommand("select * from " + _dataBaseName + "." + palaRoot.postExTable + " where post_id = ?post_id"))
                    {
                        ...
                        //赋值文章列表单文章信息
                        postEx.post_id = Convert.ToInt32(r["post_id"]);

                        postEx.count_read = Convert.ToInt32(r["count_read"]);
                        postEx.count_review = Convert.ToInt32(r["count_review"]);
                        postEx.count_like = Convert.ToInt32(r["count_like"]);

                        postEx.tagA = Convert.ToString(r["tagA"]);
                        postEx.tagB = Convert.ToString(r["tagB"]);
                        postEx.tagC = Convert.ToString(r["tagC"]);

                        postEx.color_strip = Convert.ToString(r["color_strip"]);
            ...
            /// Post获得器
            /// </summary>
            public class GetPost : Page, Ipala
            {
                #region 字段、构造和接口实现
                ...
                /// 获取index页面普通文列数据
                /// </summary>
                /// <returns>返回普通文章List post</returns>
                public List<post> idx_comnPost()
                {
                    try
                    {
                        //定义List
                        ...
                        //获得展示可用的文列文章post表
                        using (DataTable postTable = MySqlConnectionHandler.getTable("select * from " + _dataBaseName + "." + palaRoot.indexCommonPoatListView))
                        {
                            foreach (DataRow r in postTable.Rows)
                            {
                                ...
                                //赋值文章列表单文章信息
                                post.post_id = Convert.ToInt32(r["post_id"]);
                                post.post_title = Convert.ToString(r["post_title"]);
                                post.post_summary = Convert.ToString(r["post_summary"]);
                                post.post_archive = Convert.ToString(r["post_archive"]);

                                post.date_created = Convert.ToDateTime(r["date_created"]);
                ...
                public List<post> idx_comnPost(int beginPlace, int length)
                {
                    try
                    {
                        ...
                        //获得展示可用的文列文章post表
                        using (MySqlCommand MySqlCommand = new MySqlCommand("select * from " + _dataBaseName + "." + palaRoot.indexCommonPoatListView + " LIMIT ?beginPlace , ?length"))
                        {
                            //添加参数
                            MySqlCommand.Parameters.AddWithValue("?beginPlace", beginPlace);
                            MySqlCommand.Parameters.AddWithValue("?length", length);
                            //获得文章表
                ...
                /// <summary>
                /// 获取index页面置顶文章数据 注意，当存在多个置顶文章时，只会获取到第一个文章
                /// </summary>
                /// <returns>返回置顶文章post</returns>
                public post idx_topPost()
                {
                    try
                    {
                        post post = new post();
                        ...
                        //获得展示可用的置顶文章post行
                        using (MySqlCommand MySqlCommand = new MySqlCommand("select * from " + _dataBaseName + "." + palaRoot.indexToppingPostListView))
                        {
                ...
                /// 获取index页面菜单文列数据
                /// </summary>
                /// <returns>返回菜单文列的List post</returns>
                public List<post> idx_menuPost()
                {
                    try
                    {
                        List<post> postList = new List<post>();
                        ...
                        //获得展示可用的菜单文章post表
                        using (DataTable postTable = MySqlConnectionHandler.getTable("select * from " + _dataBaseName + "." + palaRoot.indexMenuPostListView))
                        {
                            foreach (DataRow r in postTable.Rows)
                            {
                                //定义单post来组成post清单
                                post e_post = new post();

                                //赋值文章列表单文章信息（1.1可用取代）
                                e_post.post_id = Convert.ToInt32(r["post_id"]);
                                e_post.post_title = Convert.ToString(r["post_title"]);
                ...
                /// <returns>返回文章数据post</returns>
                public post pst_post(int post_id)
                {
                    try
                    {
                        post post = new post();
                        ...
                        //建立一个cmd对象，用于执行参数化查询
                        using (MySqlCommand MySqlCommand = new MySqlCommand("select * from " + _dataBaseName + "." + palaRoot.wordPostView + " where post_id = ?post_id"))
                        {
                            MySqlCommand.Parameters.AddWithValue("?post_id", post_id);//添加参数
                            ...
                            foreach (DataRow r in postTable.Rows)
                            {
                                ...
                                post.post_title = Convert.ToString(r["post_title"]);
                                post.post_summary = Convert.ToString(r["post_summary"]);
                                post.post_content = Convert.ToString(r["post_content"]);
                                post.post_archive = Convert.ToString(r["post_archive"]);
                                post.post_isReadOnly = Convert.ToBoolean(r["post_isReadOnly"]);

                                post.date_created = Convert.ToDateTime(r["date_created"]);
                                post.date_changed = Convert.ToDateTime(r["date_changed"]);
                            }
            ...
            /// Post编辑器
            /// </summary>
            public class SetPost : Page, Ipala
            {
                #region 字段、构造和接口实现
